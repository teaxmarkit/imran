  ...
  return (
    <div className='banner h-50 pt-10 bg-blue flex flex-col-reverse items-center justify-between md:flex-row md:h-100' >
        <motion.div variants={bannerTextContentVariant} initial='initial' animate='final' className='bg-transparent mx-5 p-2 md:px-10'>
            <motion.h1 variants={bannerTitleVariant}  className="text-2xl text-white font-bold font-poppinsMedium md:text-5xl" color='white'>Welcome to Rude Roses</motion.h1>
            <motion.p variants={bannerTextVariant}  className="my-2 text-gray-400 text-xl font-poppinsLight">Pampering your petals with soaps,body creams,bath bombs,chap stick,and hand sanitizer.</motion.p>
        </motion.div>
        <img  className="m-6 w-30" style={{width:aboutImgWidth}}  src='/Skincare-amico.png' alt="Banner Image" />
    </div>
  )
}
